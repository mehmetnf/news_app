...
abstract class IHomeRepository {
  ...
  ResultDecode<TopNews, APIError> topNews({required String language});
  ResultDecode<AllNews, APIError> allNews({required String categories,required String language});
}
