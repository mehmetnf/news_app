...
class _$DataModelImpl implements _DataModel {
  ...
  @override
  String toString() {
    return 'DataModel(uuid: $uuid, title: $title, description: $description, keywords: $keywords, snippet: $snippet, url: $url, image_url: $image_url, language: $language, published_at: $published_at, source: $source, categories: $categories, relevance_score: $relevance_score, locale: $locale)';
  }
