...
abstract class $CategoriesModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? key, String? image});
}
...
class _$CategoriesModelImpl implements _CategoriesModel {
  _$CategoriesModelImpl({this.key, this.image});
  ...
  @override
  String toString() {
    return 'CategoriesModel(key: $key, image: $image)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, key, image);
...
abstract class _CategoriesModel implements CategoriesModel {
  factory _CategoriesModel({final String? key, final String? image}) =
